...
import { Box, Avatar, Button, Dialog, DialogActions, DialogContent, DialogTitle, TextField, InputLabel, FormControl, Select, MenuItem } from "@mui/material";
  ...
  return (
    <Dialog open={isOpen}>
      ...
      <DialogContent>
        ...
        <TextField sx={{ m: 0.5 }} onChange={onChangeFunction} name="email" label="Email Address" fullWidth></TextField>
        <TextField sx={{ m: 0.5 }} onChange={onChangeFunction} name="phoneNumber" label="Phone Number" fullWidth></TextField>
        <TextField sx={{ m: 0.5 }} onChange={onChangeFunction} name="address" label="Address" fullWidth></TextField>
        <TextField sx={{ m: 0.5 }} onChange={onChangeFunction} name="university" label="University Name" fullWidth></TextField>
        <Box >
      ...
      <DialogActions>
        <Button onClick={() => close()} color="secondary">Already have an account? Sign in</Button>
